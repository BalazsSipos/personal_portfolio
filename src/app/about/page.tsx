...
export default function About() {
  const myLifeTexts = [
    'My name is Balazs, I live with my wife and my two sons in Hungary. I do Track and Field Decathlon, as my main sport. I like the versatility of  it, to be forced to have multiple skills for the runs, jumps and throws.',
  ];
  ...
  const softwareDeveloperTexts = [
    'I started to work as a software developer 5 years ago. I worked on backend side (Javascript, Java and C#) and on frontend side (React) as well.',
